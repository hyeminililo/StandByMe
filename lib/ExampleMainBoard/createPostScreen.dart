...
class ExampleCreatPostScreen extends StatefulWidget {
  final Function(String, String)? onDropdownValueChanged;

  const ExampleCreatPostScreen({Key? key, this.onDropdownValueChanged})
      : super(key: key);

  @override
  State<ExampleCreatPostScreen> createState() => _ExampleCreatPostScreenState();
}

//formkey로 받은 것들이 한 번에 넘어갈 수 있는지 ex) 하나의 정보 게시팜 모델테이블에 넣어서 담아갈 수 있는?ㅇ
class _ExampleCreatPostScreenState extends State<ExampleCreatPostScreen> {
  ...
  ExampleMainBoardModel boardModel = ExampleMainBoardModel(
      id: 0,
      title: 'title',
      contents: 'contents',
